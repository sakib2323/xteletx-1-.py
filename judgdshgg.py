...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Muhammad tamim
\033[1;37m Facebook:            Muhammad tamim
\033[1;37m Github  :            Sakib2323
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('https://t.ly/Ecacn/J3gpK8NYNQBHhEYnVxN4X7')
        pass
    elif select =='F':
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +tamim)
    os.system('sort -r '+tamim+' | uniq > '+tamim)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + tamim )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
